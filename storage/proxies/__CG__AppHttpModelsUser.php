...
namespace DoctrineProxies\__CG__\App\Http\Models;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \App\Http\Models\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['name' => NULL, 'about' => NULL, 'email' => NULL, 'password' => NULL, 'confirmationToken' => NULL, 'isActive' => NULL, 'rememberToken' => NULL, 'createdAt' => NULL, 'updatedAt' => NULL, 'blogs' => NULL, 'categories' => NULL, 'userRoles' => NULL];
    ...
    {
        unset($this->name, $this->about, $this->email, $this->password, $this->confirmationToken, $this->isActive, $this->rememberToken, $this->createdAt, $this->updatedAt, $this->blogs, $this->categories, $this->userRoles);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'about', 'email', 'password', 'confirmationToken', 'isActive', 'rememberToken', 'createdAt', 'updatedAt', 'blogs', 'categories', 'userRoles', 'connection', 'table', 'primaryKey', 'keyType', 'incrementing', 'with', 'withCount', 'perPage', 'exists', 'wasRecentlyCreated', 'attributes', 'original', 'changes', 'casts', 'dates', 'dateFormat', 'appends', 'dispatchesEvents', 'observables', 'relations', 'touches', 'timestamps', 'hidden', 'visible', 'fillable', 'guarded', 'rememberTokenName'];
        }

        return ['__isInitialized__', 'id', 'connection', 'table', 'primaryKey', 'keyType', 'incrementing', 'with', 'withCount', 'perPage', 'exists', 'wasRecentlyCreated', 'attributes', 'original', 'changes', 'casts', 'dates', 'dateFormat', 'appends', 'dispatchesEvents', 'observables', 'relations', 'touches', 'timestamps', 'hidden', 'visible', 'fillable', 'guarded', 'rememberTokenName'];
    }
    ...
    public function onPreUpdate(\Doctrine\ORM\Event\PreUpdateEventArgs $eventArgs)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'onPreUpdate', [$eventArgs]);
