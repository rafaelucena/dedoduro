...
@section('content')
<div class="card">
    <div class="card-header">Sources - View All <a href="{{ route('sources.create') }}" class="btn btn-primary float-right btn-sm mr-2"><i class="fas fa-plus"></i> Add</a></div>
...
$(document).ready(function() {
    $('#dataTable').DataTable({
        ...
        "language": {
            ...
            "emptyTable": "No Sources Found, Create the first category.",
            "oPaginate": {
        ...
        buttons: [
            {
                ...
                action: function ( e, dt, node, config ) {
                    if (confirm('Are you sure?')) {
                        ...
                        window.location.href = '{{ route("sources.bulkDelete") }}?ids=' + selectedIds;
                    }
                },
